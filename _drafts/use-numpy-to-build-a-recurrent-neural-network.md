...
Here's the code for basic rnn cell:
``` python
import numpy as np
...
def rnn_cell_forward(xt, a_prev, parameters):
  """
      ...
      Arguments:
      xt -- your input data at timestep "t", numpy array of shape (n_x, m). m is batch size
...
The rnn cell will repeat itself in time dimension N times, depending on how long the input is.
![pic](/assets/postfiles/imgs/rnn_forward.png)
```python
...
```
## 2.1 LSTM cell one step forward
![pic](/assets/postfiles/imgs/lstm.png)
```python
...
![pic](/assets/postfiles/imgs/lstm_rnn.png)
```python
